...
def main(session):
    ...
    # subscribe to ALMood extractors
    ...
    mood = moodService.getEmotionalReaction()
    
    # and say the analysed mood
    tts.say("The mood is : "  + str(mood))
    
    # unsubscribe to ALMood extractors
