...
<Package name="10-004-request_weather" format_version="4">
    <Manifest src="manifest.xml" />
    <BehaviorDescriptions>
        <BehaviorDescription name="behavior" src="behavior_1" xar="behavior.xar" />
    </BehaviorDescriptions>
    <Dialogs>
        <Dialog name="weather" src="weather/weather.dlg" />
    </Dialogs>
    <Resources>
    ...
    <Topics>
        <Topic name="weather_enu" src="weather/weather_enu.top" topicName="weather" language="en_US" />
    </Topics>
    <IgnoredPaths>
